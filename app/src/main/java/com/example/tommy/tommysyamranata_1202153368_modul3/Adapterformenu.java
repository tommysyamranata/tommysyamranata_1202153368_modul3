...
/**
 * Created by tommy on 24/02/18.
 */

public class Adapterformenu extends RecyclerView.Adapter<Adapterformenu.holdermn> {
    private Context context;
    private List<menulist> daftarmenu;

    //adpater yang akan menyiapkan layout untuk daftar menu
    public Adapterformenu(Context context, List<menulist> daftarmenu) {
